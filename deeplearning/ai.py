...
def comment_data_dict_tag(comment_data_dict, tag_contune):
    feeling_dict = {}
    for reply_id in list(comment_data_dict.keys()):
        if tag_contune:
            if reply_id not in feeling_dict.keys():
                os.system('cls')
                retry_flag = True
                while retry_flag:
                    upper_tree_list = []
                    ...
                    input_error = True
                    while input_error:
                        postive = input("Is message positive?(-1/1 , 1 is postive): ")
                        postive = int(postive)
                    ...
                    input_error = True
                    while input_error:
                        happiness = input("How happy is this message? (0/10): ")
                    ...
                    input_error = True
                    while input_error:
                        sadness = input("How sad is this message? (0/10): ")
                        sadness = int(sadness)
                    ...
                    input_error = True
                    while input_error:
                        angry = input("How angry is this message? (0/10): ")
                        angry = int(angry)
...
try :
    ...
    encode_comment_dict, dec_dict, enc_dict = message_encode_comment_dict(
        comment_data_dict=comment_data_dict, auto_update=True, enc_dict=None, dec_dict=None, encode_comment_dict=None, overwrite_flag=True)
    tag_coment_dict = comment_data_dict_tag(comment_data_dict, tag_contune)
